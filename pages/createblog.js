            ...
            <div className="border-b border-gray-900/10 pb-12">
              <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div className="col-span-full">
                  <label htmlFor="countries" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select an Catagories</label>
              ...
              <div className="mt-2">
                ...
                <input onChange={change} value={data.url} name="url" type="text" id="url" autoComplete="given-name" className="block w-[50vw] rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 placeholder:px-1" placeholder='Enter Url here' />
              </div>
            </div>
          </div>
